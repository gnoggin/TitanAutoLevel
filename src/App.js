...
const ImageOverlay = ({ isVisible }) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        width: 'calc(100% - 50px)', // Reduce width to account for left and right padding
        height: 'calc(100% - 80px)', // Reduce height to account for top and bottom padding
        padding: '0px',
        backgroundImage: 'url("/diagram01.jpg")',
...
function App() {
  ...
  const sections = [
    { title: "Let's Get Things Started", content: "After unhitching from the tow vehicle and with the trailer slightly above level, press the START AUTO LEVEL button.", color: "#2f2f2f", text: "This is section 1, isn't it lovely and working perfectly?" },
    { title: "Auto-cycle Step 1", content: "The front landing gear with retract lowering front of the unit slightly below level.", color: "#595959", text: "Welcome to section 2, where the magic continues!" },
    { title: "Auto-cycle Step 2", content:`The rear jacks will then extend, lifting the reearend to level the unit front-to-back.
									 
    • If three was more information to describe, we could push the content upward to reveal more content.`, color: "#2f2f2f", text: "Section 3 is here, full of bullet points and excitement!" },
    { title: "Auto-cycle Step 3", content: `The left side leveling jack extends and raises the roadside of the unit, followed by the right side jack raising the curbside of the unit.`, color: "#595959", text: "You've reached section 4, the content keeps getting better!" },
    { title: "How Does it Work?", content: "This is the final section.", color: "#2f2f2f", text: "The grand finale! Section 5 wraps up our journey." },
  ];
  ...
  const scrollToSection = useCallback((sectionIndex) => {
    ...
    if (container) {
      ...
      setShowImageOverlay(sectionIndex === 4); // Show image overlay for section 5 (index 4)
    }
  ...
  const handleScroll = useCallback(() => {
    ...
    if (container) {
      ...
      if (newSection !== currentSection) {
        ...
        setShowImageOverlay(newSection === 4); // Show image overlay for section 5 (index 4)
      }
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        width: '100%',
        height: '40px',
        backgroundColor: 'rgba(64, 64, 64, 0.8)', // Dark gray with 80% opacity
        display: 'flex',
        alignItems: 'center',
        padding: '0 10px',
        zIndex: 1000, // Ensure it's above the Spline animation
      }}>
        {/* Back Button Icon */}
        <svg 
          width="24" 
        ...
        {sections.map((section, index) => (
          ...
          >
            ...
            <div style={{
              ...
              <h2 style={{ fontSize: '1.3em' }}>{section.title}</h2>
              <div 
                ...
                style={{ 
                  ...
                  fontSize: '18px' // Set content text size to 20px
                }}
              >
                {section.content}
              </div>
