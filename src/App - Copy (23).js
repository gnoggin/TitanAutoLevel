...
function App() {
  ...
  const sections = [
    { title: "Let's Get Things Started", content: "On the CAMPING SCREEN, press START AUTO LEVEL, or if you desire a custom set point, press SET POINT 1, 2, or 3 and START.", color: "#2f2f2f", text: "This is section 1, isn't it lovely and working perfectly?" },
    { title: "Auto-cycel Step 1", content: "Here's some information for section 2.", color: "#595959", text: "Welcome to section 2, where the magic continues!" },
    { title: "Auto-cycel Step 2", content: `Section 3 contains this text. 
      • Bullet point 1
      • Bullet point 2
      • Bullet point 3
      • Bullet point 4`, color: "#2f2f2f", text: "Section 3 is here, full of bullet points and excitement!" },
    { title: "Auto-cycel Step 3", content: `Welcome to section 4. This section now contains more content:
      • Bullet point 1
      • Bullet point 2
      • Bullet point 3
      • Bullet point 4
