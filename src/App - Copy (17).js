...
function App() {
  ...
  const sections = [
    { title: "Section 1", content: "This is the content for section 1.", color: "#2f2f2f" },
    { title: "Section 2", content: "Here's some information for section 2.", color: "#595959" },
    ...
    { title: "Section 4", content: `Welcome to section 4. This section now contains more content:
      ...
      • Bullet point 8
      • Bullet point 9
      • Bullet point 10`, color: "#595959" },
    { title: "Section 5", content: "This is the final section.", color: "#2f2f2f" },
  ];
  ...
  }, [updateSplineObject, updateSplineSection, playAudio, currentSection]);
