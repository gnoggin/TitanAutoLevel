...
const TitleArea = ({ title, onBackClick }) => (
  <div style={{
    position: 'fixed',
    top: 0,
    left: 0,
...
function App() {
  ...
  const handleBackClick = useCallback(() => {
    ...
    // For example, you might want to navigate to a different page or reset the state
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', overflow: 'hidden', position: 'relative' }}>
      <div style={{ 
        ...
        left: 0,
        right: 0,
        bottom: expandedSection !== null ? '60%' : '30%',
        transition: 'bottom 0.3s ease-in-out'
      }}>
        <Spline
      ...
      <TitleArea title="Your Dashboard Title" onBackClick={handleBackClick} />
