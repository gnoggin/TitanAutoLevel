...
function App() {
  ...
  const sections = [
    { title: "Let's Get Things Started", content: "This is the content for section 1.", color: "#2f2f2f", text: "This is section 1, isn't it lovely and working perfectly?" },
            ...
            <div style={{
              ...
              <div 
                ...
                style={{ 
                  ...
                  fontSize: '20px' // Set content text size to 20px
                }}
              >
                {section.content}
              </div>
